...
while True :
    name = st.text_input("Enter Your Name", "Name", key="name" )
    gender_input = st.text_input("Enter Your Gender (F for female, M for male)", "Gender", key="gender_input" )
    ...
    else : st.text("Incorrect Gender Entered.")
...
"Time flies with a "+str(name)+", as they are simply\nmesmerizing.",
...
heshe+"'s adorable, "+heshe+"'s amazing, "+heshe+"'s just awesome",
...
girlguy+"s really admire a "+guygirl+" like "+himher+" cuz "+heshe+"'s got most\nof the skills..",
...
heshe+" is liked by everyone and also has a great\ntaste in fashion.",
...
"Everything "+heshe+" does is so perfect,\nwhen you see "+himher+"..",
